...
## 1.2. 与webpack类似的工具还有哪些？谈谈你为什么最终选择（或放弃）使用webpack

+ webpack 适用于大型复杂的前端站点构建
  
+ rollup 适用于基础库的打包，如vue、react

## 1.3. 有哪些常见的Loader？他们是解决什么问题的
...
## 1.4. 有哪些常见的Plugin？他们是解决什么问题的

+ define-loader: 定义环境变量
+ commons-chunk-plugin: 提取公共代码
+ uglifyjs-webpack-plugin：通过UglifyES压缩ES6代码

## 1.5. Loader和Plugin的不同
...
## 1.6. webpack的构建流程是什么?从读取配置到输出文件这个过程尽量说全
...
## 1.7. 是否写过Loader和Plugin？描述一下编写loader或plugin的思路
...
## 1.8. webpack的热更新是如何做到的？说明其原理

webpack的热更新又称热替换（Hot Module Replacement），缩写为HMR。 这个机制可以做到不用刷新浏览器而将新变更的模块替换掉旧的模块。
![如图所示](https://raw.githubusercontent.com/bylh/files/main/images/20201204200610.png)
...
## 1.9. 如何利用webpack来优化前端性能？（提高性能和体验）
...
## 1.12. npm打包时需要注意哪些？如何利用webpack来更好的构建
